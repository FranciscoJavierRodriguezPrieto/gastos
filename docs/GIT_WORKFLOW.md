...
| 12 | `feature/invitacion-pareja` | **Actual** | El titular invita con un código de un solo uso y la pareja se da de alta ella misma eligiendo su contraseña. Sustituye a `POST /auth/members`, donde el titular elegía la contraseña del otro. |
