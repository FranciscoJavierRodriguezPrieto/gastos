...
| 12 | `feature/invitacion-pareja` | **Actual** | El titular invita con un código de un solo uso y la pareja se da de alta ella misma eligiendo su contraseña. Sustituye a `POST /auth/members`, donde el titular elegía la contraseña del otro. Incluye cerrar el ADR-0002: la API va a Koyeb, y **Render queda descartado** porque sus horas son por workspace y agotarlas suspende todos los servicios gratuitos de la cuenta. |
